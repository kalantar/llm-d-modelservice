...
- name: {{ default "vllm" .container.name }}
  ...
  startupProbe:
    {{- toYaml . | nindent 4 }}
  {{- end }}
  {{- (include "llm-d-modelservice.resources" (dict "resources" .container.resources "parallelism" .parallelism "container" .container "Values" .Values "pdSpec" .pdSpec)) | nindent 2 }}
